    ...
    <div class="bg-white rounded-3xl shadow-xl border border-slate-200 overflow-hidden">
                  ...
                  <div class="flex items-center justify-between">
                    ...
                    <div class="flex space-x-2">
                      <a href="/sign?doc={{.DocID}}"
                         class="inline-flex items-center px-3 py-2 text-sm font-medium text-primary-700 bg-primary-50 rounded-lg hover:bg-primary-100 hover:text-primary-800 transition-all duration-200 border border-primary-200 hover:border-primary-300">
                      ...
                      <a href="/status?doc={{.DocID}}"
                         class="inline-flex items-center px-3 py-2 text-sm font-medium text-slate-600 bg-slate-50 rounded-lg hover:bg-slate-100 hover:text-slate-900 transition-all duration-200 border border-slate-200 hover:border-slate-300">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {{else}}
        ...
        <div class="px-8 py-16 text-center">
          ...
          <a href="/"
             class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-primary-600 to-primary-700 hover:from-primary-500 hover:to-primary-600 text-white font-semibold rounded-2xl transition-all duration-200 shadow-lg hover:shadow-xl hover:scale-[1.02]">
